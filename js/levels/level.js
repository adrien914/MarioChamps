(function() {
  var Level = Mario.Level = function(options) {
    ...
    this.underFloorSprite = options.underFloorSprite;
    ...
    this.shellSprite = options.shellSprite;
    ...
    //real pipe sprites, use these.96
  ...
  Level.prototype.putFloor = function(start, end) {
    for (var i = start; i < end; i++) {
      ...
      this.statics[14][i] = new Mario.Floor([16*i,224], this.underFloorSprite);
    }
  };
