var oneone = Mario.oneone = function() {
  ...
  level = new Mario.Level({
    ...
    exit: 204,
    // [0,0]=position sur la charte des sprites, [16,16] = taille sur la charte, 0 = frame sur laquelle render
    floorSprite:  new Mario.Sprite('sprites/tiles.png', [0,0],[16,16],0),
    underFloorSprite: new Mario.Sprite('sprites/tiles.png', [0,3],[16,13],0),
   ...
   goombaSprite: function() {
     //[0,16]=start pos in sprite sheet, [16,16]=size of each sprite
     //3 = numbers of frames between each sprite rendering
     //[0,1]= what sprites to render, 0,1 = sprite at position 0, then sprite at pos 1
     //remember that we specified that each sprite is 16*16px
     return new Mario.Sprite('sprites/enemy.png', [0, 16], [16,16], 3, [0,1]);
   },
   koopaSprite: function() {
     return new Mario.Sprite('sprites/enemy.png', [96,0], [16,32], 2, [0,1]);
   },
   shellSprite: function() {
     return new Mario.Sprite('sprites/enemy.png', [160,16], [16,16], 2, [0,1,2,3]);
   },
   flagPoleSprites: [
  ...
  level.putWall(0,13, 10);
  level.putGoomba(19,7);
